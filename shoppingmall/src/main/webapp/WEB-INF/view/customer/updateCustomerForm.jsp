		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md probootstrap-animate" >
					<form method="post" class="probootstrap-form" action="${pageContext.request.contextPath}/UpdateCustomerController" id="signupForm">
						<div class="row mb-5">
							<div class="col-md">
				...
				<div class="col-md">
					<h2 class="heading mb-2 display-4 font-light probootstrap-animate">CUSTOMER UPDATE</h2>
...
>>>>>>> branch 'master' of https://github.com/gdj46-blueteam/shoppingmall.git
=======
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<!DOCTYPE html>
