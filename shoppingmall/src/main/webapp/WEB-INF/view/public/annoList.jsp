	...
	<section class="probootstrap-cover overflow-hidden relative" style="background-image: url('assets/images/Jeju.jpg');"data-stellar-background-ratio="0.5" id="section-home">
		...
		<div class="container">
			<div class="row align-items-center">	
									...
									<table class="probootstrap-date-wrap table table-striped">
										...
										<c:forEach var="a" items="${announcementList}">
											<tr>
												...
												<td><a href="SelectAnnoOneController?announcementNo=${a.announcementNo}" style="color: black; text-decoration: underline;">${a.announcementTitle}</a></td>
											</tr>
										</c:forEach>
										</tbody>
									</table>
				...
				<div class="col-md">
					<h2 class="heading mb-2 display-4 font-light probootstrap-animate">ANNOUNCEMENT</h2>
