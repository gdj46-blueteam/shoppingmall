...
<head>
<meta charset="UTF-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge"> <!--호환성무시?-->
...
<body>
 <div class="tm-main-content" id="top">
            ...
            <div class="tm-top-bar" id="tm-top-bar"> <!--로고있는 top-->
                <div class="container">
                    <div class="row">
                        <nav class="navbar navbar-expand-lg narbar-light">
                            ...
                            <div id="mainNav" class="collapse navbar-collapse tm-bg-white"> <!--nav바-->
        ...
        <div class="tm-page-wrap mx-auto">
            <section class="tm-banner"> <!--banner-->
                <div class="tm-container-outer tm-banner-bg">
                    <div class="container"> <!--top~선택창-->

                        <div class="row tm-banner-row tm-banner-row-header"> <!--top~ 선택창-->
                            <div class="col-xs-12">
                        ...
                        <div class="row tm-banner-row" id="tm-section-search"> 
                            <form action="index.html" method="get" class="tm-search-form tm-section-pad-2"> <!--옵션 창-->
                                <div class="form-row tm-search-form-row">     <!--옵션 윗부분-->                           
