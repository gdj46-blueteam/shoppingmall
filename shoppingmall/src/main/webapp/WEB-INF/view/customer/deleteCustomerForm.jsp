		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md probootstrap-animate" >
					<form id="signupForm" method="post" class="probootstrap-form" action="${pageContext.request.contextPath}/DeleteCustomerController">
						<div class="row mb-2">
							<div class="col-md">
				...
				<div class="col-md">
				<h2 class="heading mb-2 display-4 font-light probootstrap-animate">DELETE</h2>
